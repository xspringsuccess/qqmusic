<!-- <template>
	<div class="page playing-container">
		<mt-header fixed title="songMsg.data.songname" class="music-header-3 playing-header">
				...
				<div class="ablum-wrapper">
					<transition :css="false" @enter="_bounceDown" appear>
						<div class="title-wrap">
					    	<p>
					    		<img src="../assets/img/horizontal.png" width="18">
			...
			<transition :css="false" @enter="_bounceUp" appear>
				<div class="play-wrapper">
					...
					<div class="play-control">
						<img :src="require(`../assets/img/${playOrder}.png`)" @click="switchPlayOrder" class="order-icon">
						<img @click="playSong('prev')" src="../assets/img/back.png" class="back-icon">
						<img @click="pause(playingState == 'pause' ? '' : 'pause')" 
							 :src="require(`@/assets/img/${this.songState.playingState == 'pause' ? 'play-2':'pause-2'}.png`)"
							 class="play-icon">
						<img @click="playSong('next')" src="../assets/img/prev.png" class="back-icon">
						<img src="../assets/img/list.png" class="list-icon" @click="toggleShow">
					</div>
				</div>
			</transition>
		</div>
